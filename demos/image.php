...
<body class="bg-gray-50 min-h-screen">
  <div class="max-w-lg mx-auto py-10">
    ...
    <form method="post" class="flex gap-2 mb-4">
      <input name="prompt" required maxlength="100" class="flex-1 p-2 border rounded" placeholder="Describe your image..." <?php if(!$allowed || !demoProviderReady()) { echo 'disabled'; } ?>>
